...
class StatusRoutes {
     ...
     */
    setupRoutes(app, isAuthenticated, isAuthenticatedOrApiKey) {
        app.get("/favicon.ico", isAuthenticated, (req, res) => res.sendStatus(204));

        // Return no identifying metadata, even after health authentication.
        app.get("/health", isAuthenticatedOrApiKey, (req, res) => res.sendStatus(204));
