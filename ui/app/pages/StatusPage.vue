                    ...
                    <div class="status-card">
                        ...
                        <div class="status-list">
                            <div class="status-item">
                                ...
                                <a href="#" class="repo-link" @click.prevent>
                                    {{ t("connected") }}
                                </a>
                            </div>
                            <div class="status-item">
...
const downloadUsageStats = async () => {
    ...
    try {
        ...
        const filename = `usage-stats_${formatDownloadTimestamp()}.jsonl`;
        const a = document.createElement("a");
...
const downloadCurrentLogs = () => {
    ...
    const filename = `runtime-logs_${formatDownloadTimestamp()}_${state.logCount}.log`;
